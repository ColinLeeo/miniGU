...
db_path=$workspace/datasets/stats_ceb/minigu_db
pattern_dir=$workspace/pattern_gcard/stats_ceb
graph_name=stats_ceb
output_dir=$workspace/results/gcard/estimate
output_log=$output_dir/stats_ceb_k${k}_p${predicate_apply_type}_d0.log
