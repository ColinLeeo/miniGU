...
k=${2:-3}
sample_size=${3:-500}
predicate_apply_type=${4:-0}

workspace=$(realpath "$(dirname "$0")/../../")
minigu=$workspace/../target/release/minigu
db_path=$workspace/datasets/ldbc/sf$sf/minigu_db
pattern_dir=$workspace/pattern_gcard/ldbc_with_pred_30
graph_name=ldbc
output_dir=$workspace/results/gcard/estimate
output_log=$output_dir/ldbc_with_pred_30_sf${sf}_k${k}_p${predicate_apply_type}_d0.log
